        ...
        <div class="container">
            <div class="body-content1">
                ...
                <div class="logo-search">
                    <div class="logo">
                        <h1><a href="index.html">k<span class="color">i</span><span class="color1">d</span><span
                                    class="color2">s</span> <span>school</span> <i>Good Start To Your Child</i></a></h1>
                    </div>
                    <div class="search">
                        <form>
                ...
                <div class="banner-bottom">
                    <div class="banner-bottom-grids">
                        <div class="col-md-4 banner-bottom-grid">
                            ...
                            <h2><i>" Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium dolor
                                    emque laudantium. "</i></h2>
                                        ...
                                        <div class="l_g">
                                            <div class="banner-bottom-grid1">
                                                ...
                                                <div class="col-xs-8 banner-bottom-grid-left">
                                                    <h4><a href="single.html">unde omnis iste natus error sit
                                                            voluptatem</a></h4>
                                                </div>
                                                <div class="clearfix"> </div>
                                            </div>
                                            <div class="banner-bottom-grid1">
                                                ...
                                                <div class="col-xs-8 banner-bottom-grid-left">
                                                    <h4><a href="single.html">"Lorem ipsum dolor consectetur
                                                            adipiscing</a></h4>
                                                </div>
                                                <div class="clearfix"> </div>
                                            </div>
                                            <div class="banner-bottom-grid1">
                                                ...
                                                <div class="col-xs-8 banner-bottom-grid-left">
                                                    <h4><a href="single.html">culpa qui officia deserunt mollit anim
                                                            id</a></h4>
                                                </div>
                                                <div class="clearfix"> </div>
                                            </div>
                                            <div class="banner-bottom-grid1">
                                                ...
                                                <div class="col-xs-8 banner-bottom-grid-left">
                                                    <h4><a href="single.html">Itaque earum rerum hic tenetur a
                                                            sapiente</a></h4>
                                                </div>
                                                <div class="clearfix"> </div>
                                            </div>
                                            <div class="banner-bottom-grid1">
                                                ...
                                                <div class="col-xs-8 banner-bottom-grid-left">
                                                    <h4><a href="single.html">ut aut reiciendis voluptatibus maiores</a>
                                                    </h4>
                                                </div>
                                                <div class="clearfix"> </div>
                                            </div>
                            ...
                            <div class="banner-bottom-grid-fig">
                                <div class="banner-bottom-grid-fig1">
                                    ...
                                    <div class="banner-bottom-grid-fig1-pos">
                                        <a href="single.html">At vero eos et accusamus et iusto odio dignissimos
                                            ducimus</a>
                                        <p><i class="glyphicon glyphicon-time" aria-hidden="true"></i>March 20, 2016 By
                                            <a href="single.html">Andrew Smith</a>
                                        </p>
                                    </div>
                                </div>
                                <div class="banner-bottom-grid-fig-grid">
                                    <div class="banner-bottom-grid-fig-grid1">
                                        <h4><span>Plan-1</span><a href="single.html">Sed ut perspiciatis unde omnis iste
                                                natus</a></h4>
                                        <p><i class="glyphicon glyphicon-time" aria-hidden="true"></i>March 25, 2016 By
                                ...
                                <div class="banner-bottom-grid-fig-grid">
                                    <div class="banner-bottom-grid-fig-grid1">
                                        <h4><span>Plan-2</span><a href="single.html">Neque porro quisquam est, qui
                                                dolorem ipsum quia</a></h4>
                                        <p><i class="glyphicon glyphicon-time" aria-hidden="true"></i>March 28, 2016 By
                                            <a href="single.html">Laura James</a>
                                        </p>
                                    </div>
                                </div>
                                <div class="banner-bottom-grid-fig-grid">
                                    <div class="banner-bottom-grid-fig-grid1">
                                        <h4><span>Plan-3</span><a href="single.html">Similique sunt in culpa qui officia
                                                deserunt</a></h4>
                                        <p><i class="glyphicon glyphicon-time" aria-hidden="true"></i>March 30, 2016 By
                                            <a href="single.html">Fedrick</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
